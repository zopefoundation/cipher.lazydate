...
class Calendar:
    ...
    def _buildTime(self, source, quantity, modifier, units):
        """
        Take C{quantity}, C{modifier} and C{unit} strings and convert them into
        values.
    ...
    def _evalModifier(self, modifier, chunk1, chunk2, sourceTime):
        ...
        if unit == 'week' or \
            ...
            if offset == 0:
                ...
                return self._evalModifier(
                    modifier, chunk1, "monday " + chunk2, sourceTime)
    ...
    def parse(self, datetimeString, sourceTime=None):
        ...
        while len(s) > 0:
            ...
            if _debug:
                ...
                print('dayStr %s, modifier %s, modifier2 %s, units %s,'
                      ' qunits %s' %
            ...
            if parseStr != '':
                if self.modifierFlag is True:
                    t, totalTime = self._evalModifier(
